...
def test_anomaly_detector_triggers_alert(capsys):
    """ se detecte y dispare la alerta correspondiente si supera el umbral."""
    ...
    assert (
        "[ALERTA CONSOLA]: Anomalía detectada en TEMP-ALERT. Valor: 25.5"
        in captured.out
    )


def test_anomaly_detector_no_alert(capsys):
    """Prueba que NO se dispare ninguna alerta ."""
